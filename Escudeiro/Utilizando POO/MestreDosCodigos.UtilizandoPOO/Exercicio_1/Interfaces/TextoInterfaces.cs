...
namespace MestreDosCodigos.UtilizandoPOO.Exercicio_1.Interfaces
{
    public static class TextoInterfaces
    {
        public static void MostrarIDisposable()
        {
            ...
            ConsoleHelper.VideClasse("MestreDosCodigos.UtilizandoPOO.Exercicio_1.Interfaces", "Descartavel");
        ...
        public static void MostrarIEnumerable()
        {
            ...
            ConsoleHelper.VideClasse("MestreDosCodigos.UtilizandoPOO.Exercicio_1.Interfaces", "ListaDeEnumeravel");
            ConsoleHelper.VideClasse("MestreDosCodigos.UtilizandoPOO.Exercicio_1.Interfaces", "Enumerador");
        ...
        public static void MostrarIComparable()
        {
            ...
            ConsoleHelper.VideClasse("MestreDosCodigos.UtilizandoPOO.Exercicio_1.Interfaces", "MinhaClasse");
